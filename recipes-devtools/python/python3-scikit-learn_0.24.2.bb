...
export NUMPY_INCLUDE_PATH = "${STAGING_LIBDIR}/${PYTHON_DIR}/site-packages/numpy/core/include"
...
do_compile_prepend() {
	...
	cp ${STAGING_LIBDIR}/${PYTHON_DIR}/site-packages/numpy/core/lib/npy-pkg-config/* ${WORKDIR}/npy-pkg-config
	sed -i 's&prefix=${pkgdir}&prefix=${STAGING_LIBDIR}/${PYTHON_DIR}/site-packages/numpy/core&g' ${WORKDIR}/npy-pkg-config/npymath.ini
	sed -i 's&prefix=${pkgdir}&prefix=${STAGING_LIBDIR}/${PYTHON_DIR}/site-packages/numpy/core&g' ${WORKDIR}/npy-pkg-config/mlib.ini
}
