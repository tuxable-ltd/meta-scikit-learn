...
export NUMPY_INCLUDE_PATH = "${STAGING_DIR_TARGET}/usr/lib/python3.7/site-packages/numpy/core/include"
...
do_compile_prepend() {
	...
	cp ${STAGING_DIR_TARGET}/usr/lib/python3.7/site-packages/numpy/core/lib/npy-pkg-config/* ${WORKDIR}/npy-pkg-config
